...
def parse_args():
    ...
    parser.add_argument('-p','--pivots', metavar='PIVOTS', nargs='+', type=int, help='Numeric id(s) of the Facebook accounts known to have mutual friends with the target. Their friends list must be public. Can be a single value or a comma separated list of values.')
